const subheadingsData = {
  1: [
    {
      ...
      content: (
        <>
          <p>
            I am highly motivated to constantly acquire new knowledge and to prove myself in challenging projects. 
            With my willingness to learn and my commitment, I am ready to take on any challenge and make a significant contribution to the success of my team.
          </p>
        </>
      ),
    },
  ...
  3: [
    ...
    {
      title: "2022 Software Developer",
      content: (
        <>
          <p>
          <ul>
              <li>
                Support in the creation and review of requirement specifications for MS SharePoint WebParts<br/>
              </li>
              <li>
                Independent software development of WebParts in the (SPFx) framework of Microsoft 365 based on TypeScript and React<br/>
              </li>
              <li>
                Carrying out tests, verification and logging of results Collaboration with developers in the agile product team
              </li>
            </ul>
          </p>
        </>
